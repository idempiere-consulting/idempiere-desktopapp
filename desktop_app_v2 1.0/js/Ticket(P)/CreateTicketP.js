    ...
    select_reqType.addEventListener('change', function (event) {
        ...
        if (select_reqType.value == 'AN') {
            var text = `<label class="formLabel" for="explain">Descrivi il problema</label>
                    <textarea id="explain" name="explain" placeholder="Es: Utilizzando il processo XDF20 volevo creare la fattura " style="height:80px; width: 100%;"></textarea>`;
            ...
            text = `<label class="formLabel" for="explain2">Dettaglio errore a video</label>
                <textarea id="explain2" name="explain2" placeholder="Es: Nessuno/Documento non trovato" style="height:80px; width: 100%;"></textarea>`;
            caseDiv.innerHTML += text;

            text = `<label class="formLabel" for="explain3">Azione che si stava facendo</label>
                <textarea id="explain3" name="explain3" placeholder="Es: Creazione fattura processo XDF20" style="height:80px; width: 100%;"></textarea>`;
            caseDiv.innerHTML += text;

            text = `<label class="formLabel" for="explain4">E' urgente/bloccante?</label>
                <textarea id="explain4" name="explain4" placeholder="Es: Non è bloccante dovrei fare la fattura entro qualche giorno" style="height:80px; width: 100%;"></textarea>`;
            caseDiv.innerHTML += text;
        ...
        if (select_reqType.value == 'NR') {
            var text = `<label class="formLabel" for="explain">Spiega cosa vorresti che sia sviluppato su Idempiere</label>
                    <textarea id="explain" name="explain" placeholder="Scrivi qualcosa..." style="height:80px; width: 100%;"></textarea>`;
        ...
        if (select_reqType.value == 'OT') {
            var text = `<label class="formLabel" for="explain">Spiega il problema non classificabile dal Tipo Richiesta</label>
                    <textarea id="explain" name="explain" placeholder="Write something.." style="height:80px; width: 100%;"></textarea>`;
